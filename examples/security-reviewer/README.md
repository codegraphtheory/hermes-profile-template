...
Security review is easier to evaluate when findings are tied to concrete code, configuration, and architecture evidence. This example shows a profile for application security review, secure code review, authentication and authorization checks, secret-handling review, and dependency risk triage.

Use it when a maintainer wants actionable risk findings with severity, exploit path, remediation, and verification steps.
